...
function App() {
  ...
  const [isVisible, setIsVisible] = useState({
    //need to make education the educationList and not EducationForm
    personal: true,
    experience: false,
    education: false,
  });
  ...
  const handleArrayChange = (property, event, setState) => {
    const value = event.target.value;
    setState((prev) => ({
      ...prev,
      [property]: value,
    ...
    <>
      <div className="main-container">
        ...
        <div className="form-container">
          ...
          />
          {isVisible.education && (
            <div id="education-form" className="form-wrapper">
          ...
          {isVisible.experience && (
            <div id="experience-form" className="form-wrapper">

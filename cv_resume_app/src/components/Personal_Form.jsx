      ...
      {isVisible.personal && <div id='personal-form' className='form-wrapper'>
        ...
        <form action="post" className='form'>
          <InputWithLabel 
            htmlFor='name'
            desc='Name'
            placeholder={personal.name ? personal.name : getItem(PERSONAL_KEY, 'name')}
            onChange={(event) => onChange('name', event, PERSONAL_KEY, setPersonal)}
          />
          <InputWithLabel 
            htmlFor='email'
            desc='Email'
            placeholder={personal.email ? personal.email : getItem(PERSONAL_KEY, 'email')}
          ...
          <InputWithLabel 
            ...
            inputType='tel'
            desc='Phone'
            placeholder={personal.phone ? personal.phone : getItem(PERSONAL_KEY, 'phone')}
